...
keywords: ["Telegram group settings", "Telegram chat history", "collony bot setup", "Telegram moderation permissions"]
---
...
<Tip>
  collony AI needs access to past messages to moderate effectively and generate accurate responses.
</Tip>

<Warning>
  Apply this setting to every group where collony will be active – including the dashboard group (explained later). If chat history is hidden, collony cannot review past conversations and its capabilities will be limited.
</Warning>