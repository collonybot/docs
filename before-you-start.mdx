...
keywords: ["create Telegram group", "Telegram community setup", "add collony bot", "Telegram group admin"]
---
...
<Tip>
  If you don't have a Telegram community yet, create one first before inviting the collony bot.
</Tip>