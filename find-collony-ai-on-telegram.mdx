...
keywords: ["find collony bot", "CollonyBot Telegram", "official collony bot", "Telegram bot search"]
---
...
<Warning>
  Always verify that the handle is **@CollonyBot** and that the profile name matches the official collony bot before adding it to your group.
</Warning>